...
async function findTaskForUser(taskId: string, userId: string): Promise<TaskRecord> {
...
async function restartDevServer(sandbox: Sandbox, packageJson: PackageJson, logger: TaskLoggerInstance): Promise<void> {
