...
/**
 * This script previously hosted the manual sandbox smoke test. The task is now complete
 * and the implementation has been intentionally removed to avoid accidental usage.
 *
