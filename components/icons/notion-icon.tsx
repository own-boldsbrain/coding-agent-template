...
const NotionIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 32 32" fill="none" aria-labelledby="notion-icon-title" {...props}>
    <title id="notion-icon-title">Notion</title>
    <path
      fill="currentColor"
