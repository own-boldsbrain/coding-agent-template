...
const ConvexIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" aria-labelledby="convex-icon-title" {...props}>
    <title id="convex-icon-title">Convex</title>
    <path
      fill="currentColor"
